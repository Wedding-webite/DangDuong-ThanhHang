...
(function($) {
  ...
  THEMEMASCOT.isLTR = {
	...
	if($('.time-countdown-two').length){  
		...
		var $this = $(this), finalDate = $(this).data('countdown');
		$this.countdown(finalDate, function(event) {
			var $this = $(this).html(event.strftime('' + '<div class="counter-column"><span class="count">%m</span><sub>Tháng</sub></div> ' + '<div class="counter-column"><span class="count">%D</span><sub>Ngày</sub></div> ' + '<div class="counter-column"><span class="count">%H</span><sub>Giờ</sub></div>  ' + '<div class="counter-column"><span class="count">%M</span><sub>Phút</sub></div>  ' + '<div class="counter-column"><span class="count">%S</span><sub>Giây</sub></div>'));
		});
	});
	}
